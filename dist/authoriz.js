...
/* harmony import */ var _styles_authoriz_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @styles/authoriz.css */ "./styles/authoriz.css");
...
/* harmony import */ var _blocks_login_login_css__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @blocks/login/login.css */ "./common.blocks/login/login.css");
/* harmony import */ var _blocks_go_button_go_button_css__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @blocks/go-button/go-button.css */ "./common.blocks/go-button/go-button.css");
/* harmony import */ var _blocks_input_input_css__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @blocks/input/input.css */ "./common.blocks/input/input.css");
/* harmony import */ var _blocks_registration_registration_css__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @blocks/registration/registration.css */ "./common.blocks/registration/registration.css");
/* harmony import */ var _blocks_title_title_css__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @blocks/title/title.css */ "./common.blocks/title/title.css");
function _createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it.return != null) it.return(); } finally { if (didErr) throw err; } } }; }
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendors-node_modules_jquery_dist_jquery_js","node_modules_normalize_css_normalize_css-common_blocks_footer_footer_css-fonts_fontawesome_al-ff57be"], function() { return __webpack_require__("./scripts/authoriz.js"); })
